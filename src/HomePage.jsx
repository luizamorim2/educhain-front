          ...
          <div className="hero-style1 text-center">
            ...
            <div className="btn-group custom-anim-top wow animated">
              <Link to="/registerInstitution" className="th-btn">
                Cadastrar Instituição <i className="fa-solid fa-arrow-right ms-2"></i>
              </Link>
            </div>
            <div
                ></div>
            ...
            <div className="btn-group custom-anim-top wow animated">
              <Link to="/certificate/" className="th-btn">
                Verificar certificado <i className="fa-solid fa-arrow-right ms-2"></i>
              </Link>
            </div>
          </div>
        </div>
            ...
            <div className="row align-items-center justify-content-center">
              <div className="col-lg-6">
                <p className="copyright-text bg-repeat">
                  <i className="fas fa-copyright"></i> EduChain. Todos os
                  direitos reservados.
                </p>
              </div>
            </div>
